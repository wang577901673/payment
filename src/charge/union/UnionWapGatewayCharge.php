...
use payment\common\union\data\charge\WapGatewayData;

/**
 * @author: zero
 * @Class Config
 * @createTime: 2018-09-14
 * @description: 银联wap网关支付
 * @link https://github.com/lettellyou/payment
 */

class UnionWapGatewayCharge extends UnionBaseStrategy
{
